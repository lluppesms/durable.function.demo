...
// --------------------------------------------------------------------------------
module logAnalyticsWorkspaceModule 'br/mybicepregistry:loganalyticsworkspace:LATEST' = {
...
module keyVaultModule 'br:workshopbcr.azurecr.io/bicep/keyvault:LATEST' = {
